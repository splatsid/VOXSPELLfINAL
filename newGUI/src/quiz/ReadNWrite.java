...
public class ReadNWrite {
	/*
	 * This class' responsibilities are to be able to read and write to every file that is associated with a quiz, and the application
	 *
	 */
	
	private File f;
	/*
	 * Constructor for the ReadNWrite class
	 */
	public ReadNWrite(File file) {
		this.f = file;
	}

	//Get all the possible words from a particular level this is for the default wordlist.
	...
	//Gets the current skin that is set.
